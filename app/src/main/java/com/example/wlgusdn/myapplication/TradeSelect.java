...
public class TradeSelect extends AppCompatActivity implements View.OnClickListener
{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    Toast.makeText(TradeSelect.this,"입찰 취소하기",Toast.LENGTH_LONG).show();
                    //서버에서 데이터 삭제
                }
    ...
    private void initFirebaseDatabase() {
        ...
        mDatabaseReference.child(postnum).child(Sellid).addChildEventListener(mChildEventListener);
        ...
        mFirebaseDatabase.getReference("users")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.child(OppositeId).child("TradeAlarm").getValue(true).toString().equals("true")) {
            ...
            case R.id.btn_send1:
                ...
                if (!TextUtils.isEmpty(message)) {
                    ...
                    chatData.time = System.currentTimeMillis();
                     ...
                     mDatabaseReference.child(postnum).child(Sellid).push().setValue(chatData);
    ...
    class decisionAsync extends AsyncTask<Void, String, Void> {
        protected Void doInBackground(Void... voids) {//user thread
            ...
            if (button.getText().equals("거래 결정하기"))
                ...
                url = "http://52.79.255.160:8080/auctioncancel.jsp";
            Document xml = null;
            String param = "?postnum=" + postnum + "&sellerid=" + Sellid+"&condition=1";
            String u = url + param;
            try {
                xml = Jsoup.connect(u).get();//url에 접속해서 xml파일을 받아옴
            } catch (IOException e) {
