...
public class BidderListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        ImageView BidderImage = convertView.findViewById(R.id.SellImage);


        BidderDataCompanyName.setText("기업명 : "+BidderData.get(position).BidderCompanyName);
        BidderDataTradeNum.setText("거래횟수 : "+BidderData.get(position).BidderTradeCount+"회");
        ...
        BidderImage.setImageBitmap(BidderData.get(position).bmp);
        return convertView;
    }
}
