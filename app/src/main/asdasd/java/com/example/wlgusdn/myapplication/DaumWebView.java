...
public class DaumWebView extends AppCompatActivity {
    ...
    public void init_webView() {
        ...
        // webview url load
        webView.loadUrl("http://18.217.201.58/daumweb.php");
    }
    ...
    {
        Toast.makeText(DaumWebView.this,result.getText(),Toast.LENGTH_SHORT).show();
        Intent intent = new Intent();
        intent.putExtra("Adress", result.getText());
